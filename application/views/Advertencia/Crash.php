  ...
  <nav class="navbar navbar-light bg-light">
    <div class="container-fluid">
      <div class="container" style="text-align:center;">
            <p align="center"><FONT FACE="Segoe UI" SIZE="6"> Borrar Solicitud </FONT></p>  
      </div>
    </div>
  </nav>
...
<h1 align= "center"> ¿Desea eliminar esta solicitud? <h1>

<div class="d-grid gap-2 col-6 mx-auto  align-items-center vh-100">
<a style="background-color:black; color:white; margin-top:-290px;" class="btn btn-dark" type="button" href="<?=base_url('index.php/AdministrarSolicitudC/show/')?>">
    Eliminar solicitud
</a>
<div>
