...
<body>
  ...
  <div>
    <h5>
      <p align="center"><FONT FACE="Segoe UI" FONT SIZE="6"> Solicitud </FONT></p>  
    </h5>
  </div>

  <div align="right" style= "padding:0px 100px 10px 15px">
    <div class="btn-group" role="group" aria-label="Basic outlined example">
    <a style="background-color:white; color:black;" class="btn btn-dark" type="button" href="<?=base_url('index.php/Emp_Repor/ConsultarReporte/')?>">
                 Consultar reporte
      </a> 
    <a style="background-color:white; color:black;" class="btn btn-dark" type="button" href="<?=base_url('index.php/Emp_Repor/Borrar/')?>">
                 Eliminar reporte
       </a> 
  </div></div>
