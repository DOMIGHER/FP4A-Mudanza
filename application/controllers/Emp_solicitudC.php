<?php
class Emp_solicitudC extends CI_Controller
{
    public function show()
    {
        $this->load->model('Emp_solicitudM');
        $data['soli'] = $this->Emp_solicitudM->getDatos();
        $this->load->view('encabezados/head.php');
        $this->load->view('encabezados/menu.php');
        $this->load->view('Empleado/Emp_solicitudV.php', $data);
